...
export default async function CategoryPage() {
  const listings = await prisma.listing.findMany({
    where: { status: "ACTIVE", category: { in: ["FASHION", "SNEAKERS"] } },
    take: 24,
    ...
    <div className="min-h-screen bg-[#050505] pt-20">
      <div className="bg-[#030303] border-b border-[rgba(201,168,76,0.1)] py-12 px-6">
        <div style={{maxWidth:1280,margin:"0 auto"}}>
          ...
          <h1 style={{fontFamily:"Cormorant Garamond,serif",fontSize:"clamp(2rem,5vw,3.5rem)",fontWeight:300,color:"#F0EAD0"}}>Fashion</h1>
